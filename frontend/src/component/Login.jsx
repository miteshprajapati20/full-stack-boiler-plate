        ...
        <div className="login-form-container">
          <form onSubmit={handleLogin} className="login-form">
            ...
            <div className="form-group">
              ...
              <div className="password-icon-container" onClick={() => setIsShowPass(!isShowPass)}>

                {
                  isShowPass ?
                    ( 
                      <svg id="show-password" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    :
                    ( 
                      <svg id="hide-password" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="login-btn-container">
              <button className="login-btn" type="submit" disabled={(!loginForm.email || !loginForm.password || loginForm.password.length < 6) ? true : false}>
